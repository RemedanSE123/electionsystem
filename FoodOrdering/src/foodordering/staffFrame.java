...
public class staffFrame extends javax.swing.JFrame {
    ...
    public staffFrame() {
        ...
        try{
            ...
            int index = 0;
            String orders[],order_string = "",line;
            while ((line=reader.readLine())!=null){
                order_string+=line+"__orders__";
                
            }
            orders = order_string.split("__orders__");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Staff Members Dashboard");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            int serial = 1;
            while ((line=reader.readLine())!=null){
                String single_order[] = line.split("--");
                for(String ord :single_order){
                    orders+=String.valueOf(serial)+". " + ord.split("~")[0]+ "\t\t"+ord.split("~")[1]+ "\t\t"+ ord.split("~")[2] + "\n";
                    serial++;
                }
            }
